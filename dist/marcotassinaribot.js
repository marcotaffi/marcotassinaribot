...
(async () => {
    ...
    */
        ...
        //--------------
        //CARICAMENTO MODERNO
        const socialMarcoLinkedin = await ServiceFactory.create("linkedin_marcot_post");
        ...
        const segnalazioneEventiApg23 = await ServiceFactory.create("segnalazioneeventi_apg23");
    ...
    */
        ...
        if (process.env.MARCOTASSINARIBOT_TAFFISERVER_SEGRETO)
            bot.setSegreto(process.env.MARCOTASSINARIBOT_TAFFISERVER_SEGRETO);
